...
//
//  Copia del modulo di projects/EnvNode_C3/ (stesso codice: e' puro, non
//  dipende dalla scheda). Qui serve ancora di piu': i nomi delle cartelle
//  e dei file del timelapse SONO la data e l'ora dello scatto.
//
//  La XIAO ESP32-S3 Sense non ha un RTC tamponato a batteria, come nessuna
//  delle schede di questo repo. L'orologio di sistema (letto/scritto con le
//  API standard time.h, che sotto usano l'RTC interno del chip) va quindi
//  "seminato" a un valore plausibile prima ancora che il WiFi sia su,
//  altrimenti riparte da epoch 0 (1 gennaio 1970) — vedi
//  rtctime_seedFromBuild().
//
//  Sequenza d'uso in setup(), IN QUEST'ORDINE:
//    1) rtctime_begin(TZ_POSIX)            — imposta il fuso (setenv+tzset)
