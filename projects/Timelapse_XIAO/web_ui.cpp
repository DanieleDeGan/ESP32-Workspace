...
//  misurato in 456 s di blocco; qui la scheda ferma dentro un handler
//  non fa scattare il timelapse, e gli slot persi non si recuperano perche'
//  sono ancorati all'orologio. Un cliente andato via a meta' scaricamento
//  lascia quindi un buco nella sequenza, che e' proprio cio' che un
//  timelapse non deve avere.
...
static void handleLog() {
  ...
  streamFileLimitato(server, f, "text/csv");
  f.close();
}
