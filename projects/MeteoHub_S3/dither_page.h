...
//  rilancia  python www/gen_page.py dither  prima di ricompilare.
//  (48075 byte di pagina, serviti su /immagini)
// ============================================================
...
<footer id="nav" style="display:none;max-width:1200px;margin:0 auto;padding:0 16px 24px;
  ...
  <a href="/">nodi</a> &mdash; <a href="/pannello">pannello e messaggi</a> &mdash; <a href="/analisi">analisi</a> &mdash; <a href="/batteria">batteria</a> &mdash; <a href="/immagini">componi immagine</a> &mdash; <a href="/pagine">pagine</a> &mdash; <a href="/api">API</a> &mdash; <a href="/update">aggiornamento firmware</a>
</footer>
